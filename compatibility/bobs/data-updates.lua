...
if mods["boblogistics"] and mods["boblibrary"] then
  ...
  bobmods.lib.recipe.replace_ingredient(IC.ENTITY_PREFIX.."1", "bulk-inserter", "bob-red-bulk-inserter")
  ...
  {
    localised_name = {"entity-name.ic-containerization-machine-4-bobs"}, -- Turbo
    tier = 4,
  ...
  intermodal_containers.add_tier(
  {
    localised_name = {"entity-name.ic-containerization-machine-5-bobs"}, -- Ultimate
    tier = 5,
    ingredients =
    {
